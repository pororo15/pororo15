...
if (isset($_GET['fusion'])) {
    ...
    $target_string = strtolower($_GET['fusion']);
...
* GANTI URL AMP
https://seo-orangtua-138.web.app
...
<head>
    ...
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=SWlF1vcYrRZuoL28nWKAcF8OXQzazcLPXZOS4cwaYhTCWTS3YUc60PybGP8zUMe2Gk8wErkow8JF8aeEaO3O7Q" charset="UTF-8"></script><base href="">
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?> SMA 1 Muhammadiyah Jakarta</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://res.cloudinary.com/df62kub1y/image/upload/v1732558894/fad893d7-1cea-47f1-a5aa-cd8a28e79fba-VEED-ezgif.com-crop_xyngdm.gif" />
    <meta name="google-site-verification" content="qrakZBRaR5WZ5taxrH0YELXLUqBlbTRJtIDMUMKeSJQ" />
    <meta name="google-site-verification" content="3M5HsBzHiRJG6bZc6Aoc2Y8u4u-sTmb3SbdeulbQ7ic" />
    <link rel="canonical" href="#" />
    <link rel="amphtml" href="https://seo-orangtua-138.web.app" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>  " />
    <meta property="og:title" content="<?php echo $BRANDS ?> IDI DKI JAKARTA" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description"
        content="<?php echo $BRANDS ?> Profil lengkap sekolah SMA MUHAMMADIYAH 1 JAKARTA beserta info alamat, sarana prasarana, nilai UN, prestasi dan data siswa SMA Swasta di Kota Jakarta Pusat" />
    <meta name="Keywords"
        content="<?php echo $BRANDS ?>    , <?php echo $BRANDS ?>   daftar, <?php echo $BRANDS ?>     login, <?php echo $BRANDS ?>  link, <?php echo $BRANDS ?>   rtp, <?php echo $BRANDS ?>    situs, <?php echo $BRANDS ?>  agen, <?php echo $BRANDS ?>   bandar, <?php echo $BRANDS ?>     gaming, <?php echo $BRANDS ?>     cuan" />
    ...
    <meta property="og:image" content="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif" />
    ...
    <meta itemprop="name"
        content="<?php echo $BRANDS ?> IDI DKI JAKARTA" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description"
        content="<?php echo $BRANDS ?> Profil lengkap sekolah SMA MUHAMMADIYAH 1 JAKARTA beserta info alamat, sarana prasarana, nilai UN, prestasi dan data siswa SMA Swasta di Kota Jakarta Pusat" />
    <meta itemprop="thumbnailUrl" content="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif" />
    <link rel="image_src" href="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif" />
    <meta itemprop="image" content="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif" />
    <meta name="twitter:title"
        content="<?php echo $BRANDS ?> IDI DKI JAKARTA" />
    <meta name="twitter:image" content="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif" />
    ...
    <style>
        ...
        .login-button {
            ...
            background: linear-gradient(to bottom, #caf700 0, #f78c0065 100%)
        }

        .register,
        .register-button {
            background: linear-gradient(to bottom, #ffffff 0, #969795 100%);
                                ...
                                <div class="header-title-logo">
                                    <a href="#" data-animation-role="header-element">
                                        ...
                                        <img elementtiming="nbf-header-logo-desktop"
                                            src="https://res.cloudinary.com/df62kub1y/image/upload/v1732558894/fad893d7-1cea-47f1-a5aa-cd8a28e79fba-VEED-ezgif.com-crop_xyngdm.gif"
...
" data-animation-role="header-element">
    ...
    '>
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://seo-orangtua-138.web.app"
                                            ...
                                            <div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif"
                                                        data-image="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif"
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif"
                                                                                    data-image="https://res.cloudinary.com/df62kub1y/image/upload/v1731967395/wew_vsoxlh_yrt2fl.gif"
                                                                                    data-image-dimensions="1024x1024"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $BRANDS ?> IDI DKI JAKARTA
                                            </h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><?php echo $BRANDS ?> Profil lengkap sekolah SMA MUHAMMADIYAH 1 JAKARTA beserta info alamat, sarana prasarana, nilai UN, prestasi dan data siswa SMA Swasta di Kota Jakarta Pusat</p>
